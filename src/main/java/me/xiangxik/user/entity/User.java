package me.xiangxik.user.entity;
...
@Entity
@Table(name = "tbl_user")
public class User extends DataEntity<User, Long> implements LogicDeleteable, Lockedable, Disabledable {
	...
	public boolean isSuperAdmin() {
		return Objects.equal(Type.superadmin, getType());
	}
